...
# define columns
columns = {0: 'text', 1:'dimensionality', 2:'form', 3:'motion_type',\
           4:'motion_class', 5:'motion_sense', 6:'semantic_type', \
               7:'motion_signal_type'}
...
param_selector = SequenceTaggerParamSelector(
    corpus, 
    tag_type, 
    'resources_param_selector_ilines/results_'+tag_type, 
    max_epochs=8,
    training_runs=2,
